...
__all__ = ['URL', 'URLHM', 'URLHM2', 'ACAO_DESCRIPTION', 'ACAO_TRACKER', 'FIELDS', 'CUSTOM_IDS', 'DICT_FIELDS',
           'CUSTOM_FIELDS', 'JSON_FIELDS', 'STATUS', 'ID2FIELD', 'FIELD2ID', 'TABLECOLS', 'SITUACAO', 'CANCELADA',
           'CLASSE', 'TIPO', 'SERVICOS', 'PF', 'PROCEDIMENTOS', 'ESTADOS', 'MUNICIPIOS']
...
DICT_FIELDS = {
    ...
    "Qtd_Licenciadas": int,
    "Qtd_Identificadas": int,
    "Coordenadas_Geograficas": str,
}
