...
DICT_FIELDS = {
    ...
    "PCDP": str,
    "Procedimentos": list,
    "Reservar Instrumentos?": str,
    "Reserva de Instrumentos": list,
    "Utilizou algum instrumento?": str
}
...
STATUS = {
    ...
    "Em andamento": ("Html", "Gerar Relatório", 'Reservar Instrumentos?', 'Reserva de Instrumentos'),
    "Relatando": (
        "Frequência Inicial",
        "Frequência Final",
...
ID2FIELD = {
    ...
    537: "Html",
    658: "Reservar Instrumentos?",
    659: "Reserva de Instrumentos",
    660: "Utilizou algum instrumento?"
}
...
FIELD2ID = {
    ...
    "Html": 537,
    "Reservar Instrumentos?": 658,
    "Reserva de Instrumentos": 659,
    "Utilizou algum instrumento?" : 660
}
