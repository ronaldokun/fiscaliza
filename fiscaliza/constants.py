...
# Cell
URL_PD_PUB = "https://sistemas.anatel.gov.br/fiscaliza/"
URL_PD_INTRA = "https://sistemasnet/fiscaliza"
URL_HM_PUB = "https://sistemashm.anatel.gov.br/fiscaliza"
URL_HM_INTRA = "https://sistemasnethm/fiscaliza"
URL_MAPPING = {
    (True, True): URL_HM_PUB,
    (True, False): URL_HM_INTRA,
    (False, True): URL_PD_PUB,
    (False, False): URL_PD_INTRA,
}
ACAO_DESCRIPTION = 54
ACAO_TRACKER = 2
from typing import *
