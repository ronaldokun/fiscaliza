...
__all__ = ['URL', 'URLHM', 'ACAO_DESCRIPTION', 'ACAO_TRACKER', 'KWARGS', 'IDS', 'FIELDS', 'JSON_FIELDS', 'STATUS',
           'FIELD2ID', 'TABLECOLS', 'SITUACAO', 'CANCELADA', 'RELATADA', 'CLASSE', 'TIPO', 'SERVICOS', 'PF',
           'PROCEDIMENTOS', 'ESTADOS', 'MUNICIPIOS']

# Cell
URL = "https://sistemas.anatel.gov.br/fiscaliza/"
# URLHM = "https://sistemashm.anatel.gov.br/fiscaliza"
URLHM = "https://sistemasnethm/fiscaliza"
ACAO_DESCRIPTION = 54
ACAO_TRACKER = 2
from typing import *
...
SERVICOS = {
    ...
    "805": "805 - COLETIVO - RETRANSMISSÃO DE RÁDIO NA AMAZÔNIA LEGAL",
